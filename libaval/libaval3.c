...
/*******************************************************************/
/* void pu_init_aval(AUTOMATO **, b_vector *, FILE *)              */
...
void pu_init_aval(ptr_pu,N,criterio,descritores)
AUTOMATO ** ptr_pu;
b_vector * N;
int criterio;
FILE * descritores;
...
/*******************************************************************/
/* void no_arc_init_aval(AUTOMATO **, b_vector *, int, FILE *)     */
/* Autor: Marcos L. Chaim                                          */
/* Versao: 1.0                                                     */
...
void no_arc_init_aval(ptr_arc,N,criterio,descritores)
AUTOMATO ** ptr_arc;
b_vector * N;
int criterio;
FILE * descritores;

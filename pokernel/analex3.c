...
long int offset;        /* posicao do caracter lido */
...
/* AUTOMATO FINITO (AF) */
peg_ch();
while(comprimento >= 0 && s!= FINAL_STATE)
   {
...
if(s == FINAL_STATE)
	...
	if(comprimento <= 0)
		...
		error("* *Erro Fatal: analisador lexico: erro na determinacao de EOF! * *\n");
